// Include this code in your script.js file
document.addEventListener("DOMContentLoaded", function () {
    // var contain = document.getElementsByID("chart-container");
    // contain.style.position = 'relative';
    // contain.style.left = '30%';
    // contain.style.bottom = '100%';
    ...
    var areaSeries = chart.addAreaSeries({
        topColor: 'rgba(28, 172, 120, 0.56)',
        bottomColor: 'rgba(28, 172, 120, 0.04)',
        lineColor: 'rgba(28, 172, 120, 1)',
      lineWidth: 2,
